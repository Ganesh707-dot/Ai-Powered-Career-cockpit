...
export function Sidebar() {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-40 hidden w-[260px] flex-col border-r border-sidebar-border bg-sidebar/95 backdrop-blur-xl max-xl:!hidden xl:flex">
